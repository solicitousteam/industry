...
var value = ''
const ImdCyclone = ({ navigation, route }) => {
    ...
    <SafeAreaView style={styles.container}>
          ...
          <View
            ...
            <View style={{ width: "80%", paddingRight: "10%" }}>
              <Text
                ...
                {strings("ImdCyclone.lbl_imd_cyclone")}
              </Text>
            </View>
      ...
      <View style={{ flex: 1 }}>
        <WebView
          ...
          source={{ uri: "https://mausam.imd.gov.in/imd_latest/contents/cyclone.php" }}
