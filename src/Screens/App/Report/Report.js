  ...
  const DATA = [
    {
      ...
      title: strings("CycloneDetails.lbl_risk_analysis_report"),
      uri: require('../../../../assets/Report.png'),
    },
    {
      id: '58694a0f-3da1-471f-bd96-145571e29d72',
      title: strings("CycloneDetails.lbl_state_combined_report"),
      uri: require('../../../../assets/Report.png'),
    },
    {
      id: '58694a0f-3da1-471f-bd96-145571e29d72',
      title: strings("Report.lbl_cyclone_details"),
      uri: require('../../../../assets/Report.png'),
    },
    {
      id: '58694a0f-3da1-471f-bd96-145571e29d72',
      title: strings("ImdCyclone.lbl_imd_cyclone"),
      uri: require('../../../../assets/Report.png'),
    }
  ];
    ...
    return (
      <Item
        ...
        onPress={() => {
          ...
          if (item.title === strings("Report.lbl_cyclone_details")) {
            navigation.navigate('CycloneDetails');
          }
          if (item.title === strings("ImdCyclone.lbl_imd_cyclone")) {
            navigation.navigate('ImdCyclone');
          }
          ...
          <View
            ...
            <View style={{ width: "70%" }}>
              <CustomText
                ...
                {strings("Report.lbl_reports_caps")}
              </CustomText>
            </View>
